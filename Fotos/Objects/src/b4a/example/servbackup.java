...
public class servbackup extends android.app.Service{
	public static class servbackup_BR extends android.content.BroadcastReceiver {

		@Override
		public void onReceive(android.content.Context context, android.content.Intent intent) {
            BA.LogInfo("** Receiver (servbackup) OnReceive **");
    ...
    static servbackup mostCurrent;
	public static BA processBA;
    private ServiceHelper _service;
    public static Class<?> getObject() {
		return servbackup.class;
	}
	@Override
	public void onCreate() {
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.servbackup", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
        if (!false && ServiceHelper.StarterHelper.startFromServiceCreate(processBA, false) == false) {
            ...
            BA.LogInfo("*** Service (servbackup) Create ***");
    ...
    private void handleStart(android.content.Intent intent) {
    	BA.LogInfo("** Service (servbackup) Start **");
	...
	public void onDestroy() {
        super.onDestroy();
        if (false) {
            BA.LogInfo("** Service (servbackup) Destroy (ignored)**");
        }
        else {
            BA.LogInfo("** Service (servbackup) Destroy **");
